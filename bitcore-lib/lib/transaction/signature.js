...
function TransactionSignature(arg) {
  if (!_instanceof(this, TransactionSignature)) {
    return new TransactionSignature(arg);
  }

  if (_instanceof(arg, TransactionSignature)) {
    return arg;
  }
...
TransactionSignature.prototype._fromObject = function (arg) {
  ...
  this.signature = _instanceof(arg.signature, Signature) ? arg.signature : BufferUtil.isBuffer(arg.signature) ? Signature.fromBuffer(arg.signature) : Signature.fromString(arg.signature);
...
TransactionSignature.prototype._checkObjectArgs = function (arg) {
  ...
  $.checkState(_instanceof(arg.signature, Signature) || BufferUtil.isBuffer(arg.signature) || JSUtil.isHexa(arg.signature), 'signature must be a buffer or hexa value');
