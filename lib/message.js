...
Message.prototype._sign = function _sign(privateKey) {
  $.checkArgument(_instanceof(privateKey, PrivateKey), 'First argument should be an instance of PrivateKey');
...
Message.prototype._verify = function _verify(publicKey, signature) {
  $.checkArgument(_instanceof(publicKey, PublicKey), 'First argument should be an instance of PublicKey');
  $.checkArgument(_instanceof(signature, Signature), 'Second argument should be an instance of Signature');
  var hash = this.magicHash();
