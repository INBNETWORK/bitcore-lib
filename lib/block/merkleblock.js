...
function MerkleBlock(arg) {
  ...
  if (!_instanceof(this, MerkleBlock)) {
  ...
  if (BufferUtil.isBuffer(arg)) {
    ...
    if (_instanceof(arg.header, BlockHeader)) {
      header = arg.header;
    } else {
...
MerkleBlock.prototype.hasTransaction = function hasTransaction(tx) {
  ...
  $.checkArgument(_instanceof(tx, Transaction) || typeof tx === 'string', 'Invalid tx given, tx must be a "string" or "Transaction"');
  var hash = tx;

  if (_instanceof(tx, Transaction)) {
