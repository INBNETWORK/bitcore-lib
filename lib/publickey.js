...
function PublicKey(data, extra) {
  if (!_instanceof(this, PublicKey)) {
    return new PublicKey(data, extra);
  }

  $.checkArgument(data, 'First argument is required, please include public key data.');

  if (_instanceof(data, PublicKey)) {
...
PublicKey._isPrivateKey = function (param) {
  ...
  return _instanceof(param, PrivateKey);
};
/**
...
PublicKey._isBuffer = function (param) {
  return _instanceof(param, Buffer) || _instanceof(param, Uint8Array);
};
/**
...
PublicKey.fromPoint = function (point, compressed) {
  $.checkArgument(_instanceof(point, Point), 'First argument must be an instance of Point.');
  return new PublicKey(point, {
